...
main(void)
{
  ...
  65:	51                   	push   %ecx
  66:	51                   	push   %ecx
  67:	68 da 07 00 00       	push   $0x7da
  6c:	6a 01                	push   $0x1
  6e:	e8 bd 03 00 00       	call   430 <printf>
 ...
 43c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5cb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d0:	bb eb 07 00 00       	mov    $0x7eb,%ebx
...
free(void *ap)
{
 ...
 5e1:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 606:	73 18                	jae    620 <free+0x40>
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65d:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0x90>
    ...
    if(p == freep)
 6c1:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 70f:	89 15 ec 0a 00 00    	mov    %edx,0xaec
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 72d:	0a 00 00 
 730:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 73f:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 746:	00 00 00 
