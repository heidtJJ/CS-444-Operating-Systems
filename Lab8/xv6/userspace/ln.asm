...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 c0 07 00 00 	movzbl 0x7c0(%edx),%edx
  }while((x /= base) != 0);
 ...
 40c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 59b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a0:	bb b7 07 00 00       	mov    $0x7b7,%ebx
 ...
 5d6:	73 18                	jae    5f0 <free+0x40>
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62d:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b6:	e8 f5 fe ff ff       	call   5b0 <free>
  return freep;
 6bb:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 b0 0a 00 00    	mov    %edx,0xab0
      return (void*)(p + 1);
