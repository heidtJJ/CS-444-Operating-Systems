...
main(void)
{
  ...
  int rc = fork();
  12:	e8 53 03 00 00       	call   36a <fork>
  int fd;
  if (rc < 0)
  17:	85 c0                	test   %eax,%eax
  19:	0f 88 89 00 00 00    	js     a8 <main+0xa8>
    printf (1, "Failed");
  else if (rc == 0){
  1f:	0f 85 b3 00 00 00    	jne    d8 <main+0xd8>

    int grandChild = fork();
  25:	e8 40 03 00 00       	call   36a <fork>
    if(grandChild < 0)
  2a:	85 c0                	test   %eax,%eax
  2c:	0f 88 93 00 00 00    	js     c5 <main+0xc5>
        printf(1,"Grandchild failed\n");
    else if(grandChild == 0){
  32:	75 3e                	jne    72 <main+0x72>
	printf(1, "Grand Child's branch, start writing to file.\n");
  34:	51                   	push   %ecx
  35:	51                   	push   %ecx
  36:	68 98 08 00 00       	push   $0x898
  3b:	6a 01                	push   $0x1
  3d:	e8 8e 04 00 00       	call   4d0 <printf>
	fd = open("test.txt", O_CREATE | O_WRONLY);
  42:	5b                   	pop    %ebx
  43:	58                   	pop    %eax
  44:	68 01 02 00 00       	push   $0x201
  49:	68 7a 08 00 00       	push   $0x87a
  4e:	e8 5f 03 00 00       	call   3b2 <open>
  ...
  56:	89 c3                	mov    %eax,%ebx
	write(fd, "Hello World\n", 13);
  58:	6a 0d                	push   $0xd
  5a:	68 83 08 00 00       	push   $0x883
  5f:	50                   	push   %eax
  60:	e8 2d 03 00 00       	call   392 <write>
	close(fd);
  65:	89 1c 24             	mov    %ebx,(%esp)
  68:	e8 2d 03 00 00       	call   39a <close>
        exit();
  6d:	e8 00 03 00 00       	call   372 <exit>
    }
    else{
        
	wait();
  72:	e8 03 03 00 00       	call   37a <wait>
	printf(1, "Child's branch, list all files\n");
  77:	50                   	push   %eax
  78:	50                   	push   %eax
  79:	68 c8 08 00 00       	push   $0x8c8
  7e:	6a 01                	push   $0x1
  80:	e8 4b 04 00 00       	call   4d0 <printf>
	...
	args[1] = 0;
        exec("ls", args);
  85:	58                   	pop    %eax
  86:	8d 45 f0             	lea    -0x10(%ebp),%eax
	args[0] = "ls";
  89:	c7 45 f0 90 08 00 00 	movl   $0x890,-0x10(%ebp)
	args[1] = 0;
  90:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
        exec("ls", args);
  97:	5a                   	pop    %edx
  98:	50                   	push   %eax
  99:	68 90 08 00 00       	push   $0x890
  9e:	e8 07 03 00 00       	call   3aa <exec>
        exit();
  a3:	e8 ca 02 00 00       	call   372 <exit>
    printf (1, "Failed");
  a8:	50                   	push   %eax
  a9:	50                   	push   %eax
  aa:	68 60 08 00 00       	push   $0x860
  af:	6a 01                	push   $0x1
  ...
  c5:	50                   	push   %eax
  c6:	50                   	push   %eax
  c7:	68 67 08 00 00       	push   $0x867
  cc:	6a 01                	push   $0x1
  ce:	e8 fd 03 00 00       	call   4d0 <printf>
  d3:	83 c4 10             	add    $0x10,%esp
  d6:	eb e1                	jmp    b9 <main+0xb9>
    wait();
  d8:	e8 9d 02 00 00       	call   37a <wait>
  ...
  f2:	e8 a3 02 00 00       	call   39a <close>
    open("test.txt", O_RDONLY);
  f7:	5a                   	pop    %edx
  f8:	59                   	pop    %ecx
  f9:	6a 00                	push   $0x0
  fb:	68 7a 08 00 00       	push   $0x87a
 100:	e8 ad 02 00 00       	call   3b2 <open>
    exec("cat", arg);
 105:	5b                   	pop    %ebx
 106:	58                   	pop    %eax
 107:	8d 45 f0             	lea    -0x10(%ebp),%eax
    arg[0] = "cat";
 10a:	c7 45 f0 93 08 00 00 	movl   $0x893,-0x10(%ebp)
    arg[1] = 0;
 111:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    exec("cat", arg);
 118:	50                   	push   %eax
 119:	68 93 08 00 00       	push   $0x893
 11e:	e8 87 02 00 00       	call   3aa <exec>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46f:	f7 f6                	div    %esi
 471:	0f b6 92 28 09 00 00 	movzbl 0x928(%edx),%edx
  }while((x /= base) != 0);
 ...
 4dc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 66b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 670:	bb 20 09 00 00       	mov    $0x920,%ebx
...
free(void *ap)
{
 ...
 681:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 6a6:	73 18                	jae    6c0 <free+0x40>
{
 ...
 6d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6d9:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 6de:	5b                   	pop    %ebx
 6df:	5e                   	pop    %esi
 6e0:	5f                   	pop    %edi
 ...
 6fa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fd:	a3 28 0c 00 00       	mov    %eax,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 28 0c 00 00    	mov    0xc28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	76 3f                	jbe    7a0 <malloc+0x90>
    ...
    if(p == freep)
 761:	39 05 28 0c 00 00    	cmp    %eax,0xc28
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 7c4:	eb e9                	jmp    7af <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 7cd:	0c 00 00 
 7d0:	c7 05 2c 0c 00 00 2c 	movl   $0xc2c,0xc2c
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	b8 2c 0c 00 00       	mov    $0xc2c,%eax
 7df:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 7e6:	00 00 00 
