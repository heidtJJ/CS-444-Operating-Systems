...
printint(int fd, int xx, int base, int sgn)
{
 ...
 68f:	f7 f6                	div    %esi
 691:	0f b6 92 d4 0a 00 00 	movzbl 0xad4(%edx),%edx
  }while((x /= base) != 0);
 ...
 6fc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 88b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 890:	bb ca 0a 00 00       	mov    $0xaca,%ebx
...
free(void *ap)
{
 ...
 8a1:	a1 44 0e 00 00       	mov    0xe44,%eax
{
 ...
 8c6:	73 18                	jae    8e0 <free+0x40>
{
 ...
 8f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8f9:	a3 44 0e 00 00       	mov    %eax,0xe44
}
 8fe:	5b                   	pop    %ebx
 8ff:	5e                   	pop    %esi
 900:	5f                   	pop    %edi
 ...
 91a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91d:	a3 44 0e 00 00       	mov    %eax,0xe44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 15 44 0e 00 00    	mov    0xe44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	76 3f                	jbe    9c0 <malloc+0x90>
    ...
    if(p == freep)
 981:	39 05 44 0e 00 00    	cmp    %eax,0xe44
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 44 0e 00 00    	mov    0xe44,%edx
 ...
 9cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9cf:	89 15 44 0e 00 00    	mov    %edx,0xe44
      return (void*)(p + 1);
 ...
 9e4:	eb e9                	jmp    9cf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 9e6:	c7 05 44 0e 00 00 48 	movl   $0xe48,0xe44
 9ed:	0e 00 00 
 9f0:	c7 05 48 0e 00 00 48 	movl   $0xe48,0xe48
 9f7:	0e 00 00 
    base.s.size = 0;
 9fa:	b8 48 0e 00 00       	mov    $0xe48,%eax
 9ff:	c7 05 4c 0e 00 00 00 	movl   $0x0,0xe4c
 a06:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 a18:	f7 65 0c             	mull   0xc(%ebp)
 a1b:	70 25                	jo     a42 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 a1d:	83 ec 0c             	sub    $0xc,%esp
 a20:	89 c3                	mov    %eax,%ebx
 a22:	50                   	push   %eax
 a23:	e8 08 ff ff ff       	call   930 <malloc>
 ...
 a2e:	6a 00                	push   $0x0
 a30:	50                   	push   %eax
 a31:	e8 ba f9 ff ff       	call   3f0 <memset>
  return region;
 a36:	83 c4 10             	add    $0x10,%esp
}
 a39:	8d 65 f8             	lea    -0x8(%ebp),%esp
 a3c:	89 f0                	mov    %esi,%eax
 a3e:	5b                   	pop    %ebx
 a3f:	5e                   	pop    %esi
 a40:	5d                   	pop    %ebp
 a41:	c3                   	ret    
...
strdup(char *s)
{
 ...
 a5b:	53                   	push   %ebx
 a5c:	e8 5f f9 ff ff       	call   3c0 <strlen>
 a61:	83 c0 01             	add    $0x1,%eax
 a64:	89 04 24             	mov    %eax,(%esp)
 a67:	e8 c4 fe ff ff       	call   930 <malloc>
 a6c:	89 c6                	mov    %eax,%esi
  strcpy(buf, s);
 a6e:	58                   	pop    %eax
 a6f:	5a                   	pop    %edx
 a70:	53                   	push   %ebx
 a71:	56                   	push   %esi
 a72:	e8 c9 f8 ff ff       	call   340 <strcpy>
  return buf;
}
