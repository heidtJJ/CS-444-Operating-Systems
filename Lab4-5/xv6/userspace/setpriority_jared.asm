...
_setpriority_jared:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  2b:	56                   	push   %esi
  2c:	50                   	push   %eax
  2d:	e8 38 03 00 00       	call   36a <setpriority_jared>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
  }while((x /= base) != 0);
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb ec 07 00 00       	mov    $0x7ec,%ebx
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 e8 0a 00 00       	mov    %eax,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 714:	eb e9                	jmp    6ff <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 71d:	0a 00 00 
 720:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 72f:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 736:	00 00 00 
