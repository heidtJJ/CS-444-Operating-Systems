...
_fileopt:     file format elf32-i386
...
int main(){
  ...
  12:	68 01 02 00 00       	push   $0x201
  17:	68 b0 07 00 00       	push   $0x7b0
  ...
  24:	89 c3                	mov    %eax,%ebx
	write (fd, "Hello World", 12);
  26:	6a 0c                	push   $0xc
  28:	68 b9 07 00 00       	push   $0x7b9
  2d:	50                   	push   %eax
  2e:	e8 af 02 00 00       	call   2e2 <write>
	close(fd);
  33:	89 1c 24             	mov    %ebx,(%esp)
  36:	e8 af 02 00 00       	call   2ea <close>

	//read the file
	close(0);
  3b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  42:	e8 a3 02 00 00       	call   2ea <close>
	open("test.txt", O_RDONLY);
  47:	58                   	pop    %eax
  48:	5a                   	pop    %edx
  49:	6a 00                	push   $0x0
  4b:	68 b0 07 00 00       	push   $0x7b0
  50:	e8 ad 02 00 00       	call   302 <open>
	char * arg[2];
	arg[0] = "cat";
	arg[1] = 0;
	exec("cat", arg);
  55:	59                   	pop    %ecx
  56:	8d 45 f0             	lea    -0x10(%ebp),%eax
	arg[0] = "cat";
  59:	c7 45 f0 c5 07 00 00 	movl   $0x7c5,-0x10(%ebp)
	arg[1] = 0;
  ...
  6e:	e8 87 02 00 00       	call   2fa <exec>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 d0 07 00 00 	movzbl 0x7d0(%edx),%edx
  }while((x /= base) != 0);
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb c9 07 00 00       	mov    $0x7c9,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 cc 0a 00 00       	mov    %eax,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0x90>
    ...
    if(p == freep)
 6b1:	39 05 cc 0a 00 00    	cmp    %eax,0xacc
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 cc 0a 00 00    	mov    %edx,0xacc
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 71d:	0a 00 00 
 720:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 d0 0a 00 00       	mov    $0xad0,%eax
 72f:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 736:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 748:	f7 65 0c             	mull   0xc(%ebp)
 74b:	70 25                	jo     772 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 74d:	83 ec 0c             	sub    $0xc,%esp
 750:	89 c3                	mov    %eax,%ebx
 752:	50                   	push   %eax
 753:	e8 08 ff ff ff       	call   660 <malloc>
  memset(region, 0, full_sz);
 758:	83 c4 0c             	add    $0xc,%esp
  void *region = malloc(full_sz);
 ...
 75e:	6a 00                	push   $0x0
 760:	50                   	push   %eax
 761:	e8 ca f9 ff ff       	call   130 <memset>
  return region;
 766:	83 c4 10             	add    $0x10,%esp
}
 769:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
strdup(char *s)
{
 ...
 78b:	53                   	push   %ebx
 78c:	e8 6f f9 ff ff       	call   100 <strlen>
 791:	83 c0 01             	add    $0x1,%eax
 794:	89 04 24             	mov    %eax,(%esp)
 797:	e8 c4 fe ff ff       	call   660 <malloc>
 ...
 7a0:	53                   	push   %ebx
 7a1:	56                   	push   %esi
 7a2:	e8 d9 f8 ff ff       	call   80 <strcpy>
  return buf;
}
