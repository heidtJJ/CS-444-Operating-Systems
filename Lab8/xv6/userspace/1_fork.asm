...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 e0 07 00 00 	movzbl 0x7e0(%edx),%edx
  }while((x /= base) != 0);
 ...
 41c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5ab:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b0:	bb d8 07 00 00       	mov    $0x7d8,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 5e6:	73 18                	jae    600 <free+0x40>
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63d:	a3 d4 0a 00 00       	mov    %eax,0xad4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0x90>
    ...
    if(p == freep)
 6a1:	39 05 d4 0a 00 00    	cmp    %eax,0xad4
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 d4 0a 00 00    	mov    %edx,0xad4
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 70d:	0a 00 00 
 710:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 d8 0a 00 00       	mov    $0xad8,%eax
 71f:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 726:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 738:	f7 65 0c             	mull   0xc(%ebp)
 73b:	70 25                	jo     762 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 73d:	83 ec 0c             	sub    $0xc,%esp
 740:	89 c3                	mov    %eax,%ebx
 742:	50                   	push   %eax
 743:	e8 08 ff ff ff       	call   650 <malloc>
  memset(region, 0, full_sz);
 748:	83 c4 0c             	add    $0xc,%esp
  void *region = malloc(full_sz);
 ...
 74e:	6a 00                	push   $0x0
 750:	50                   	push   %eax
 751:	e8 ca f9 ff ff       	call   120 <memset>
  return region;
 756:	83 c4 10             	add    $0x10,%esp
}
 759:	8d 65 f8             	lea    -0x8(%ebp),%esp
 75c:	89 f0                	mov    %esi,%eax
 75e:	5b                   	pop    %ebx
 75f:	5e                   	pop    %esi
 760:	5d                   	pop    %ebp
 761:	c3                   	ret    
...
strdup(char *s)
{
 ...
 77b:	53                   	push   %ebx
 77c:	e8 6f f9 ff ff       	call   f0 <strlen>
 781:	83 c0 01             	add    $0x1,%eax
 784:	89 04 24             	mov    %eax,(%esp)
 787:	e8 c4 fe ff ff       	call   650 <malloc>
 ...
 790:	53                   	push   %ebx
 791:	56                   	push   %esi
 792:	e8 d9 f8 ff ff       	call   70 <strcpy>
  return buf;
}
