...
int main(void){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	printf(1, "Number of system calls called: %d\n", jared());
  11:	e8 14 03 00 00       	call   32a <jared>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 57b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 580:	bb 94 07 00 00       	mov    $0x794,%ebx
...
free(void *ap)
{
 ...
 591:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 5b6:	73 18                	jae    5d0 <free+0x40>
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60d:	a3 88 0a 00 00       	mov    %eax,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 88 0a 00 00    	mov    0xa88,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0x90>
    ...
    if(p == freep)
 671:	39 05 88 0a 00 00    	cmp    %eax,0xa88
 ...
 696:	e8 f5 fe ff ff       	call   590 <free>
  return freep;
 69b:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 88 0a 00 00    	mov    %edx,0xa88
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 6dd:	0a 00 00 
 6e0:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 6ef:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 6f6:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 708:	f7 65 0c             	mull   0xc(%ebp)
 70b:	70 25                	jo     732 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 70d:	83 ec 0c             	sub    $0xc,%esp
 710:	89 c3                	mov    %eax,%ebx
 712:	50                   	push   %eax
 713:	e8 08 ff ff ff       	call   620 <malloc>
 ...
 71e:	6a 00                	push   $0x0
 720:	50                   	push   %eax
 721:	e8 ba f9 ff ff       	call   e0 <memset>
  return region;
...
strdup(char *s)
{
 ...
 74b:	53                   	push   %ebx
 74c:	e8 5f f9 ff ff       	call   b0 <strlen>
 751:	83 c0 01             	add    $0x1,%eax
 754:	89 04 24             	mov    %eax,(%esp)
 757:	e8 c4 fe ff ff       	call   620 <malloc>
 ...
 760:	53                   	push   %ebx
 761:	56                   	push   %esi
 762:	e8 c9 f8 ff ff       	call   30 <strcpy>
  return buf;
}
 767:	8d 65 f8             	lea    -0x8(%ebp),%esp
