...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66f:	f7 f6                	div    %esi
 671:	0f b6 92 a0 0a 00 00 	movzbl 0xaa0(%edx),%edx
  }while((x /= base) != 0);
 ...
 6dc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 86b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 870:	bb 96 0a 00 00       	mov    $0xa96,%ebx
...
free(void *ap)
{
 ...
 881:	a1 80 0e 00 00       	mov    0xe80,%eax
{
 ...
 8a6:	73 18                	jae    8c0 <free+0x40>
{
 ...
 8d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8d9:	a3 80 0e 00 00       	mov    %eax,0xe80
}
 8de:	5b                   	pop    %ebx
 8df:	5e                   	pop    %esi
 8e0:	5f                   	pop    %edi
 ...
 8fa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8fd:	a3 80 0e 00 00       	mov    %eax,0xe80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 919:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 91c:	8b 15 80 0e 00 00    	mov    0xe80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 95f:	76 3f                	jbe    9a0 <malloc+0x90>
    ...
    if(p == freep)
 961:	39 05 80 0e 00 00    	cmp    %eax,0xe80
 ...
 986:	e8 f5 fe ff ff       	call   880 <free>
  return freep;
 98b:	8b 15 80 0e 00 00    	mov    0xe80,%edx
 ...
 9ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9af:	89 15 80 0e 00 00    	mov    %edx,0xe80
      return (void*)(p + 1);
 ...
 9c4:	eb e9                	jmp    9af <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 9c6:	c7 05 80 0e 00 00 84 	movl   $0xe84,0xe80
 9cd:	0e 00 00 
 9d0:	c7 05 84 0e 00 00 84 	movl   $0xe84,0xe84
 9d7:	0e 00 00 
    base.s.size = 0;
 9da:	b8 84 0e 00 00       	mov    $0xe84,%eax
 9df:	c7 05 88 0e 00 00 00 	movl   $0x0,0xe88
 9e6:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 9f8:	f7 65 0c             	mull   0xc(%ebp)
 9fb:	70 25                	jo     a22 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 9fd:	83 ec 0c             	sub    $0xc,%esp
 a00:	89 c3                	mov    %eax,%ebx
 a02:	50                   	push   %eax
 a03:	e8 08 ff ff ff       	call   910 <malloc>
  memset(region, 0, full_sz);
 a08:	83 c4 0c             	add    $0xc,%esp
  void *region = malloc(full_sz);
 ...
 a0e:	6a 00                	push   $0x0
 a10:	50                   	push   %eax
 a11:	e8 ba f9 ff ff       	call   3d0 <memset>
  return region;
 a16:	83 c4 10             	add    $0x10,%esp
}
 a19:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
strdup(char *s)
{
 ...
 a3b:	53                   	push   %ebx
 a3c:	e8 5f f9 ff ff       	call   3a0 <strlen>
 a41:	83 c0 01             	add    $0x1,%eax
 a44:	89 04 24             	mov    %eax,(%esp)
 a47:	e8 c4 fe ff ff       	call   910 <malloc>
 a4c:	89 c6                	mov    %eax,%esi
  strcpy(buf, s);
 a4e:	58                   	pop    %eax
 a4f:	5a                   	pop    %edx
 a50:	53                   	push   %ebx
 a51:	56                   	push   %esi
 a52:	e8 c9 f8 ff ff       	call   320 <strcpy>
  return buf;
}
 a57:	8d 65 f8             	lea    -0x8(%ebp),%esp
 a5a:	89 f0                	mov    %esi,%eax
 a5c:	5b                   	pop    %ebx
 a5d:	5e                   	pop    %esi
 a5e:	5d                   	pop    %ebp
 a5f:	c3                   	ret    
