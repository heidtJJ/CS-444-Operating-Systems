...
int main(void) {	
  ...
  11:	e8 0c 03 00 00       	call   322 <getmz>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 a4 07 00 00 	movzbl 0x7a4(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 57b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 580:	bb 9c 07 00 00       	mov    $0x79c,%ebx
...
free(void *ap)
{
 ...
 591:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 5b6:	73 18                	jae    5d0 <free+0x40>
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60d:	a3 90 0a 00 00       	mov    %eax,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 90 0a 00 00    	mov    0xa90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0x90>
    ...
    if(p == freep)
 671:	39 05 90 0a 00 00    	cmp    %eax,0xa90
 ...
 696:	e8 f5 fe ff ff       	call   590 <free>
  return freep;
 69b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 90 0a 00 00    	mov    %edx,0xa90
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 90 0a 00 00 94 	movl   $0xa94,0xa90
 6dd:	0a 00 00 
 6e0:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 94 0a 00 00       	mov    $0xa94,%eax
 6ef:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 6f6:	00 00 00 
