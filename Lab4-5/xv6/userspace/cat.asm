...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
  }while((x /= base) != 0);
 ...
 4cc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 65b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 660:	bb 88 08 00 00       	mov    $0x888,%ebx
 ...
 696:	73 18                	jae    6b0 <free+0x40>
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 c0 0b 00 00       	mov    %eax,0xbc0
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ed:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	76 3f                	jbe    790 <malloc+0x90>
    ...
    if(p == freep)
 751:	39 05 c0 0b 00 00    	cmp    %eax,0xbc0
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
 ...
 7b4:	eb e9                	jmp    79f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 c0 0b 00 00 c4 	movl   $0xbc4,0xbc0
 7bd:	0b 00 00 
 7c0:	c7 05 c4 0b 00 00 c4 	movl   $0xbc4,0xbc4
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 7cf:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 7d6:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 7e8:	f7 65 0c             	mull   0xc(%ebp)
 7eb:	70 25                	jo     812 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 7ed:	83 ec 0c             	sub    $0xc,%esp
 7f0:	89 c3                	mov    %eax,%ebx
 7f2:	50                   	push   %eax
 7f3:	e8 08 ff ff ff       	call   700 <malloc>
  memset(region, 0, full_sz);
 7f8:	83 c4 0c             	add    $0xc,%esp
  void *region = malloc(full_sz);
 ...
 7fe:	6a 00                	push   $0x0
 800:	50                   	push   %eax
 801:	e8 ba f9 ff ff       	call   1c0 <memset>
  return region;
 806:	83 c4 10             	add    $0x10,%esp
}
 809:	8d 65 f8             	lea    -0x8(%ebp),%esp
 80c:	89 f0                	mov    %esi,%eax
 80e:	5b                   	pop    %ebx
 80f:	5e                   	pop    %esi
 810:	5d                   	pop    %ebp
 811:	c3                   	ret    
...
strdup(char *s)
{
 ...
 82b:	53                   	push   %ebx
 82c:	e8 5f f9 ff ff       	call   190 <strlen>
 831:	83 c0 01             	add    $0x1,%eax
 834:	89 04 24             	mov    %eax,(%esp)
 837:	e8 c4 fe ff ff       	call   700 <malloc>
 ...
 840:	53                   	push   %ebx
 841:	56                   	push   %esi
 842:	e8 c9 f8 ff ff       	call   110 <strcpy>
  return buf;
}
