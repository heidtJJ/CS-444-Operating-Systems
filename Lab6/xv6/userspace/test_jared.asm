...
_test_jared:     file format elf32-i386
...
int main(){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	int* p;
	p = (int*)mem_jared();
  11:	e8 0c 03 00 00       	call   322 <mem_jared>
	printf(1,"address: %p\tcontent: %d \n", p, *p);
  16:	ff 30                	pushl  (%eax)
  18:	50                   	push   %eax
  19:	68 60 07 00 00       	push   $0x760
  1e:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 36f:	f7 f6                	div    %esi
 371:	0f b6 92 84 07 00 00 	movzbl 0x784(%edx),%edx
  }while((x /= base) != 0);
 ...
 3dc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 56b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 570:	bb 7a 07 00 00       	mov    $0x77a,%ebx
...
free(void *ap)
{
 ...
 581:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 5a6:	73 18                	jae    5c0 <free+0x40>
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fd:	a3 70 0a 00 00       	mov    %eax,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 70 0a 00 00    	mov    0xa70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	76 3f                	jbe    6a0 <malloc+0x90>
    ...
    if(p == freep)
 661:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 ...
 686:	e8 f5 fe ff ff       	call   580 <free>
  return freep;
 68b:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 70 0a 00 00    	mov    %edx,0xa70
      return (void*)(p + 1);
 ...
 6c4:	eb e9                	jmp    6af <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 6c6:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 6cd:	0a 00 00 
 6d0:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 74 0a 00 00       	mov    $0xa74,%eax
 6df:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 6e6:	00 00 00 
