...
main(int argc, char *argv[])
{
  ...
  28:	68 b0 07 00 00       	push   $0x7b0
  2d:	ff 74 9f fc          	pushl  -0x4(%edi,%ebx,4)
  31:	68 b2 07 00 00       	push   $0x7b2
  36:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 c0 07 00 00 	movzbl 0x7c0(%edx),%edx
  }while((x /= base) != 0);
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb b9 07 00 00       	mov    $0x7b9,%ebx
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0x90>
    ...
    if(p == freep)
 6b1:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 714:	eb e9                	jmp    6ff <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 71d:	0a 00 00 
 720:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 bc 0a 00 00       	mov    $0xabc,%eax
 72f:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 736:	00 00 00 
