...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
  }while((x /= base) != 0);
 ...
 4fc:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 68b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 690:	bb a3 08 00 00       	mov    $0x8a3,%ebx
 ...
 6c6:	73 18                	jae    6e0 <free+0x40>
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 a4 0b 00 00       	mov    %eax,0xba4
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71d:	a3 a4 0b 00 00       	mov    %eax,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	76 3f                	jbe    7c0 <malloc+0x90>
    ...
    if(p == freep)
 781:	39 05 a4 0b 00 00    	cmp    %eax,0xba4
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 7ed:	0b 00 00 
 7f0:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 a8 0b 00 00       	mov    $0xba8,%eax
 7ff:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 806:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 818:	f7 65 0c             	mull   0xc(%ebp)
 81b:	70 25                	jo     842 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 81d:	83 ec 0c             	sub    $0xc,%esp
 820:	89 c3                	mov    %eax,%ebx
 822:	50                   	push   %eax
 823:	e8 08 ff ff ff       	call   730 <malloc>
 ...
 82e:	6a 00                	push   $0x0
 830:	50                   	push   %eax
 831:	e8 ba f9 ff ff       	call   1f0 <memset>
  return region;
...
strdup(char *s)
{
 ...
 85b:	53                   	push   %ebx
 85c:	e8 5f f9 ff ff       	call   1c0 <strlen>
 861:	83 c0 01             	add    $0x1,%eax
 864:	89 04 24             	mov    %eax,(%esp)
 867:	e8 c4 fe ff ff       	call   730 <malloc>
 ...
 870:	53                   	push   %ebx
 871:	56                   	push   %esi
 872:	e8 c9 f8 ff ff       	call   140 <strcpy>
  return buf;
}
 877:	8d 65 f8             	lea    -0x8(%ebp),%esp
 87a:	89 f0                	mov    %esi,%eax
 87c:	5b                   	pop    %ebx
 87d:	5e                   	pop    %esi
 87e:	5d                   	pop    %ebp
 87f:	c3                   	ret    
