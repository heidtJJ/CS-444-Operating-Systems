...
main(void)
{
  ...
  char * arg[1];
  arg[0] = "ls";
  11:	c7 45 f4 b0 07 00 00 	movl   $0x7b0,-0xc(%ebp)
  int rc = fork();
  18:	e8 9d 02 00 00       	call   2ba <fork>
  if (rc < 0)
  1d:	85 c0                	test   %eax,%eax
  1f:	78 29                	js     4a <main+0x4a>
    printf (1, "Failed");
  else if (rc == 0){
  ...
  2d:	e8 ee 03 00 00       	call   420 <printf>
    return exec ("ls", arg);
  32:	58                   	pop    %eax
  33:	8d 45 f4             	lea    -0xc(%ebp),%eax
  36:	5a                   	pop    %edx
  37:	50                   	push   %eax
  38:	68 b0 07 00 00       	push   $0x7b0
  3d:	e8 b8 02 00 00       	call   2fa <exec>
  else{
    wait();
  ...
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 b3 07 00 00       	push   $0x7b3
  51:	6a 01                	push   $0x1
  53:	e8 c8 03 00 00       	call   420 <printf>
  58:	83 c4 10             	add    $0x10,%esp
  exit();
  5b:	e8 62 02 00 00       	call   2c2 <exit>
    wait();
  60:	e8 65 02 00 00       	call   2ca <wait>
    printf (1, "Parent's branch\n");
  65:	51                   	push   %ecx
  66:	51                   	push   %ecx
  67:	68 ca 07 00 00       	push   $0x7ca
  6c:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
  }while((x /= base) != 0);
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb db 07 00 00       	mov    $0x7db,%ebx
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 dc 0a 00 00       	mov    %eax,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0x90>
    ...
    if(p == freep)
 6b1:	39 05 dc 0a 00 00    	cmp    %eax,0xadc
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 dc 0a 00 00    	mov    %edx,0xadc
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 71d:	0a 00 00 
 720:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 e0 0a 00 00       	mov    $0xae0,%eax
 72f:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 736:	00 00 00 
