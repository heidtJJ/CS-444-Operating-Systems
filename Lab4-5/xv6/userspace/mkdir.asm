...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
  }while((x /= base) != 0);
 ...
 43c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5cb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d0:	bb f3 07 00 00       	mov    $0x7f3,%ebx
 ...
 606:	73 18                	jae    620 <free+0x40>
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65d:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0x90>
    ...
    if(p == freep)
 6c1:	39 05 f4 0a 00 00    	cmp    %eax,0xaf4
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 70f:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 72d:	0a 00 00 
 730:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
 73f:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 746:	00 00 00 
