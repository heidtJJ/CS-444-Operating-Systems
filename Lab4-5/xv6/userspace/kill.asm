 ...
 5e6:	73 18                	jae    600 <free+0x40>
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63d:	a3 b4 0a 00 00       	mov    %eax,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0x90>
    ...
    if(p == freep)
 6a1:	39 05 b4 0a 00 00    	cmp    %eax,0xab4
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 b4 0a 00 00    	mov    %edx,0xab4
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 70d:	0a 00 00 
 710:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 b8 0a 00 00       	mov    $0xab8,%eax
 71f:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 726:	00 00 00 
