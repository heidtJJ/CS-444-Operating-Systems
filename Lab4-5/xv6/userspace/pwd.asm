...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 bc 07 00 00 	movzbl 0x7bc(%edx),%edx
  }while((x /= base) != 0);
 ...
 41c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5ab:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b0:	bb b4 07 00 00       	mov    $0x7b4,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 5e6:	73 18                	jae    600 <free+0x40>
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63d:	a3 c0 0a 00 00       	mov    %eax,0xac0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0x90>
    ...
    if(p == freep)
 6a1:	39 05 c0 0a 00 00    	cmp    %eax,0xac0
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 c0 0a 00 00    	mov    %edx,0xac0
      return (void*)(p + 1);
...
calloc(uint nmemb, uint sz)
{
 ...
 74e:	6a 00                	push   $0x0
 750:	50                   	push   %eax
 751:	e8 ba f9 ff ff       	call   110 <memset>
  return region;
...
strdup(char *s)
{
 ...
 77b:	53                   	push   %ebx
 77c:	e8 5f f9 ff ff       	call   e0 <strlen>
 ...
 790:	53                   	push   %ebx
 791:	56                   	push   %esi
 792:	e8 c9 f8 ff ff       	call   60 <strcpy>
  return buf;
}
