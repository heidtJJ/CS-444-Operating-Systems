...
main(void)
{
   ...
   e:	83 ec 14             	sub    $0x14,%esp
	int j = 0;
	int rc = fork();
  11:	e8 c4 02 00 00       	call   2da <fork>
	if(rc < 0)
  16:	85 c0                	test   %eax,%eax
  18:	78 71                	js     8b <main+0x8b>
		printf(1,"Failed\n");
	else if(rc == 0){
  1a:	75 36                	jne    52 <main+0x52>
  1c:	d9 7d f6             	fnstcw -0xa(%ebp)
  1f:	0f b7 55 f6          	movzwl -0xa(%ebp),%edx
		while(1){
			j = j + 3.14*6/18;
  23:	dd 05 e8 07 00 00    	fldl   0x7e8
  29:	80 ce 0c             	or     $0xc,%dh
  2c:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  30:	89 45 ec             	mov    %eax,-0x14(%ebp)
  33:	db 45 ec             	fildl  -0x14(%ebp)
  36:	d8 c1                	fadd   %st(1),%st
  38:	d9 6d f4             	fldcw  -0xc(%ebp)
  3b:	db 5d f0             	fistpl -0x10(%ebp)
  3e:	d9 6d f6             	fldcw  -0xa(%ebp)
  41:	8b 45 f0             	mov    -0x10(%ebp),%eax
			if(j >= 300000000)
  44:	3d ff a2 e1 11       	cmp    $0x11e1a2ff,%eax
  49:	7e e5                	jle    30 <main+0x30>
  4b:	dd d8                	fstp   %st(0)
			j = j + 3.14*6/18;
			if(j >= 300000000)
				break;
  ...
  52:	d9 7d f6             	fnstcw -0xa(%ebp)
  55:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
			j = j + 3.14*6/18;
  59:	dd 05 e8 07 00 00    	fldl   0x7e8
  5f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  66:	80 cc 0c             	or     $0xc,%ah
  69:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  6d:	8d 76 00             	lea    0x0(%esi),%esi
  70:	db 45 ec             	fildl  -0x14(%ebp)
  73:	d8 c1                	fadd   %st(1),%st
  75:	d9 6d f4             	fldcw  -0xc(%ebp)
  78:	db 5d ec             	fistpl -0x14(%ebp)
  7b:	d9 6d f6             	fldcw  -0xa(%ebp)
			if(j >= 300000000)
  7e:	81 7d ec ff a2 e1 11 	cmpl   $0x11e1a2ff,-0x14(%ebp)
  85:	7e e9                	jle    70 <main+0x70>
  87:	dd d8                	fstp   %st(0)
  89:	eb c2                	jmp    4d <main+0x4d>
		printf(1,"Failed\n");
  8b:	50                   	push   %eax
  8c:	50                   	push   %eax
  8d:	68 e0 07 00 00       	push   $0x7e0
  92:	6a 01                	push   $0x1
  94:	e8 b7 03 00 00       	call   450 <printf>
  99:	83 c4 10             	add    $0x10,%esp
  9c:	eb af                	jmp    4d <main+0x4d>
  9e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
  }while((x /= base) != 0);
 ...
 45c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5eb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5f0:	bb f0 07 00 00       	mov    $0x7f0,%ebx
 ...
 626:	73 18                	jae    640 <free+0x40>
{
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67d:	a3 e4 0a 00 00       	mov    %eax,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	76 3f                	jbe    720 <malloc+0x90>
    ...
    if(p == freep)
 6e1:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 72f:	89 15 e4 0a 00 00    	mov    %edx,0xae4
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 74d:	0a 00 00 
 750:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 e8 0a 00 00       	mov    $0xae8,%eax
 75f:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 766:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 778:	f7 65 0c             	mull   0xc(%ebp)
 77b:	70 25                	jo     7a2 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 77d:	83 ec 0c             	sub    $0xc,%esp
 780:	89 c3                	mov    %eax,%ebx
 782:	50                   	push   %eax
 783:	e8 08 ff ff ff       	call   690 <malloc>
 ...
 78e:	6a 00                	push   $0x0
 790:	50                   	push   %eax
 791:	e8 ba f9 ff ff       	call   150 <memset>
  return region;
 796:	83 c4 10             	add    $0x10,%esp
}
 799:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 7a1:	c3                   	ret    
    return NULL;
 7a2:	31 f6                	xor    %esi,%esi
 7a4:	eb f3                	jmp    799 <calloc+0x29>
...
strdup(char *s)
{
 ...
 7bb:	53                   	push   %ebx
 7bc:	e8 5f f9 ff ff       	call   120 <strlen>
 7c1:	83 c0 01             	add    $0x1,%eax
 7c4:	89 04 24             	mov    %eax,(%esp)
 7c7:	e8 c4 fe ff ff       	call   690 <malloc>
 7cc:	89 c6                	mov    %eax,%esi
  strcpy(buf, s);
 7ce:	58                   	pop    %eax
 7cf:	5a                   	pop    %edx
 7d0:	53                   	push   %ebx
 7d1:	56                   	push   %esi
 7d2:	e8 c9 f8 ff ff       	call   a0 <strcpy>
  return buf;
}
