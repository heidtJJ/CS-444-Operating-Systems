...
_ps_jared:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  ps_jared();
  11:	e8 fc 02 00 00       	call   312 <ps_jared>
  exit();
...
calloc(uint nmemb, uint sz)
{
 ...
 70e:	6a 00                	push   $0x0
 710:	50                   	push   %eax
 711:	e8 ba f9 ff ff       	call   d0 <memset>
  return region;
...
strdup(char *s)
{
 ...
 73b:	53                   	push   %ebx
 73c:	e8 5f f9 ff ff       	call   a0 <strlen>
 ...
 750:	53                   	push   %ebx
 751:	56                   	push   %esi
 752:	e8 c9 f8 ff ff       	call   20 <strcpy>
  return buf;
}
