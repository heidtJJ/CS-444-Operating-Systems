...
main(void)
{
  ...
  18:	78 2f                	js     49 <main+0x49>
    printf (1, "Failed");
  else if (rc == 0){
  1a:	75 14                	jne    30 <main+0x30>
    t = 2;
    printf (1, "Child's branch, t = %d\n", t);
  1c:	51                   	push   %ecx
  1d:	6a 02                	push   $0x2
  1f:	68 b7 07 00 00       	push   $0x7b7
  24:	6a 01                	push   $0x1
  26:	e8 f5 03 00 00       	call   420 <printf>
    exit();
  2b:	e8 82 02 00 00       	call   2b2 <exit>
  }
  else{
    wait();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
  }while((x /= base) != 0);
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb e8 07 00 00       	mov    $0x7e8,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 e4 0a 00 00       	mov    %eax,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0x90>
    ...
    if(p == freep)
 6b1:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 e4 0a 00 00    	mov    %edx,0xae4
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 71d:	0a 00 00 
 720:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 e8 0a 00 00       	mov    $0xae8,%eax
 72f:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 736:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 75e:	6a 00                	push   $0x0
 760:	50                   	push   %eax
 761:	e8 ba f9 ff ff       	call   120 <memset>
  return region;
...
strdup(char *s)
{
 ...
 78b:	53                   	push   %ebx
 78c:	e8 5f f9 ff ff       	call   f0 <strlen>
 ...
 7a0:	53                   	push   %ebx
 7a1:	56                   	push   %esi
 7a2:	e8 c9 f8 ff ff       	call   70 <strcpy>
  return buf;
}
