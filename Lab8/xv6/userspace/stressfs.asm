...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47f:	f7 f6                	div    %esi
 481:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
  }while((x /= base) != 0);
 ...
 4ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 67b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 680:	bb 93 08 00 00       	mov    $0x893,%ebx
 ...
 6b6:	73 18                	jae    6d0 <free+0x40>
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70d:	a3 94 0b 00 00       	mov    %eax,0xb94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 94 0b 00 00    	mov    0xb94,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 94 0b 00 00    	mov    0xb94,%edx
 ...
 7d4:	eb e9                	jmp    7bf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 7d6:	c7 05 94 0b 00 00 98 	movl   $0xb98,0xb94
 7dd:	0b 00 00 
 7e0:	c7 05 98 0b 00 00 98 	movl   $0xb98,0xb98
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 98 0b 00 00       	mov    $0xb98,%eax
 7ef:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 7f6:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 808:	f7 65 0c             	mull   0xc(%ebp)
 80b:	70 25                	jo     832 <calloc+0x32>
    return NULL;
  void *region = malloc(full_sz);
 80d:	83 ec 0c             	sub    $0xc,%esp
 810:	89 c3                	mov    %eax,%ebx
 812:	50                   	push   %eax
 813:	e8 08 ff ff ff       	call   720 <malloc>
 ...
 81e:	6a 00                	push   $0x0
 820:	50                   	push   %eax
 821:	e8 ca f9 ff ff       	call   1f0 <memset>
  return region;
...
strdup(char *s)
{
 ...
 84b:	53                   	push   %ebx
 84c:	e8 6f f9 ff ff       	call   1c0 <strlen>
 851:	83 c0 01             	add    $0x1,%eax
 854:	89 04 24             	mov    %eax,(%esp)
 857:	e8 c4 fe ff ff       	call   720 <malloc>
 ...
 860:	53                   	push   %ebx
 861:	56                   	push   %esi
 862:	e8 d9 f8 ff ff       	call   140 <strcpy>
  return buf;
}
