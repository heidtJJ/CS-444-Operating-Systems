...
free(void *ap)
{
 ...
 5b1:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 5d6:	73 18                	jae    5f0 <free+0x40>
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 a4 0a 00 00       	mov    %eax,0xaa4
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62d:	a3 a4 0a 00 00       	mov    %eax,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0x90>
    ...
    if(p == freep)
 691:	39 05 a4 0a 00 00    	cmp    %eax,0xaa4
 ...
 6b6:	e8 f5 fe ff ff       	call   5b0 <free>
  return freep;
 6bb:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 a4 0a 00 00 a8 	movl   $0xaa8,0xaa4
 6fd:	0a 00 00 
 700:	c7 05 a8 0a 00 00 a8 	movl   $0xaa8,0xaa8
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 a8 0a 00 00       	mov    $0xaa8,%eax
 70f:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 716:	00 00 00 
