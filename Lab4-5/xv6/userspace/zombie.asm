...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 57b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 580:	bb 70 07 00 00       	mov    $0x770,%ebx
...
free(void *ap)
{
 ...
 591:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 5b6:	73 18                	jae    5d0 <free+0x40>
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60d:	a3 64 0a 00 00       	mov    %eax,0xa64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 64 0a 00 00    	mov    0xa64,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0x90>
    ...
    if(p == freep)
 671:	39 05 64 0a 00 00    	cmp    %eax,0xa64
 ...
 696:	e8 f5 fe ff ff       	call   590 <free>
  return freep;
 69b:	8b 15 64 0a 00 00    	mov    0xa64,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 64 0a 00 00    	mov    %edx,0xa64
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 64 0a 00 00 68 	movl   $0xa68,0xa64
 6dd:	0a 00 00 
 6e0:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 68 0a 00 00       	mov    $0xa68,%eax
 6ef:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 6f6:	00 00 00 
