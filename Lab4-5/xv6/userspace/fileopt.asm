...
int main(){
  ...
  56:	8d 45 f0             	lea    -0x10(%ebp),%eax
	arg[0] = "cat";
  59:	c7 45 f0 d5 07 00 00 	movl   $0x7d5,-0x10(%ebp)
	arg[1] = 0;
  60:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	exec("cat", arg);
  67:	5b                   	pop    %ebx
  68:	50                   	push   %eax
  69:	68 d5 07 00 00       	push   $0x7d5
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 e0 07 00 00 	movzbl 0x7e0(%edx),%edx
  }while((x /= base) != 0);
 ...
 43c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5cb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d0:	bb d9 07 00 00       	mov    $0x7d9,%ebx
 ...
 606:	73 18                	jae    620 <free+0x40>
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65d:	a3 dc 0a 00 00       	mov    %eax,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bf:	76 3f                	jbe    700 <malloc+0x90>
    ...
    if(p == freep)
 6c1:	39 05 dc 0a 00 00    	cmp    %eax,0xadc
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 724:	eb e9                	jmp    70f <malloc+0x9f>
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 72d:	0a 00 00 
 730:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 e0 0a 00 00       	mov    $0xae0,%eax
 73f:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 746:	00 00 00 
...
calloc(uint nmemb, uint sz)
{
 ...
 76e:	6a 00                	push   $0x0
 770:	50                   	push   %eax
 771:	e8 ba f9 ff ff       	call   130 <memset>
  return region;
...
strdup(char *s)
{
 ...
 79b:	53                   	push   %ebx
 79c:	e8 5f f9 ff ff       	call   100 <strlen>
 ...
 7b0:	53                   	push   %ebx
 7b1:	56                   	push   %esi
 7b2:	e8 c9 f8 ff ff       	call   80 <strcpy>
  return buf;
}
